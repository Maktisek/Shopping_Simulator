...
public class ItemOLD {
     ...
     */
    public ItemOLD(int price, String name, int initialPrice) throws WrongItemException{
        setPrice(price);
        this.amount = -1;
        setName(name);
        wholeBoughtPrice = 0;
    ...
    public ItemOLD(int price, int wholeBoughtPrice, String name, int amount, int initialPrice) throws WrongItemException, IllegalArgumentException{
        setPrice(price);
